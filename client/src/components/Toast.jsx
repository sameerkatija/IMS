...
export const Toast = ({ message, type = "success", onClose }) => {
  ...
  return (
    <div
      className={`fixed bottom-5 right-5 flex items-center p-4 rounded-xl border shadow-xl z-[9999] transition-all duration-300 transform translate-y-0 scale-100 no-print ${
        type === "success"
